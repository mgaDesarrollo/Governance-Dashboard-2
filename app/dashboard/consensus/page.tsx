            ...
            <Card className="bg-gray-900 border-gray-700">
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm text-gray-400">En Consenso</p>
            ...
            <Card className="bg-gray-900 border-gray-700">
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm text-gray-400">Consensuados</p>
                ...
                <Card key={report.id} className="bg-gray-900 border-gray-700 hover:border-purple-500/50 transition-all duration-200 hover:shadow-lg">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-medium text-white">{report.participants.length}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-medium text-white">{report.createdBy.name}</p>
                            </div>
                          </div>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-medium text-white mb-2">Resumen del Reporte</h4>
                        ...
                        <div className="flex items-center space-x-4">
                          {report.votingRounds.length > 0 && (
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-white font-medium">{report.votingRounds[0].roundNumber}</span>
                            </div>
                          )}
                        </div>
